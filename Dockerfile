...
COPY ops_data/ ./ops_data/
COPY fixtures/ ./fixtures/
RUN python -m ops_data.seed
USER 10001:10001
EXPOSE 8000
...
COPY interview-drills ./interview-drills
COPY START_HERE.md CURRICULUM.md CAPSTONE.md INTERVIEW_TRANSLATION.md ./
